<%-- 
    Document   : transact
    Created on : 3 Aug, 2020, 4:32:26 PM
    Author     : MUTHINA
--%>
				...
				<tr>
					<td>
						<table cellpadding="8">
							...
							<tr align="center">
								<td colspan="2">
								<input type="submit" value="Search" style="background-color: #69a74e;border-color: #69a74e;border-radius: 3px;width: 150px;padding: 5px;text-align: center;color: #fff">
								</tr>
						</table>
